...
const GEO_VIDEOS: VideoRecord[] = [
  ...
  {
    id: "springwell",
    source: "./videos/Springwell.mp4",
    left: false,
    category: "Solar",
    title: "Solar Farm Visualisation",
    url: "https://www.drt-software.com/SolarViz/",
    text1: `A planning application for a solar farm installation is typically a very time-consuming process with multiple interested parties and lots of technical documentation.`,
    text2: `This visualiation shows how the development and screening process establishes over a ten-year period.`,
    text3: undefined,
  },
  {
    id: "pollution",
